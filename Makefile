# This Makefile is for the WebService::Smartling extension to perl.
#
...
#     ABSTRACT => q[The great new WebService::Smartling!]
#     AUTHOR => q[Matthew Cox, C<< <matt.cox at runkeeper.com> >>]
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.59] }
#     DISTNAME => q[WebService-Smartling]
#     LICENSE => q[artistic]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[WebService::Smartling]
#     NO_META => q[1]
#     PREREQ_PM => { Params::Validate=>q[0], ExtUtils::MakeMaker=>q[6.59], JSON=>q[0], Readonly=>q[0], Carp=>q[0] }
#     VERSION => v0.01
#     VERSION_FROM => q[lib/WebService/Smartling.pm]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/mcox/lib/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKE = make
FULLEXT = WebService/Smartling
BASEEXT = Smartling
PARENT_NAME = WebService
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WebService/Smartling.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WebService/Smartling.pm
...
TO_INST_PM = lib/.DS_Store \
	lib/WebService/Smartling.pm

PM_TO_BLIB = lib/WebService/Smartling.pm \
	blib/lib/WebService/Smartling.pm \
	lib/.DS_Store \
	blib/lib/.DS_Store
...
DISTNAME = WebService-Smartling
DISTVNAME = WebService-Smartling-v0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WebService/Smartling.pm $(INST_MAN3DIR)/WebService::Smartling.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new WebService::Smartling!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Matthew Cox, C&lt;&lt; &lt;matt.cox at runkeeper.com&gt; &gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WebService/Smartling.pm blib/lib/WebService/Smartling.pm \
